...
func (s *optionScreen) View() string {
	...
	content += "Press '" + keys.MenuStartNewGame + "' to create a new game.\n"
	content += "Press '" + keys.MenuJoinGame + "' to join an existing game.\n"
